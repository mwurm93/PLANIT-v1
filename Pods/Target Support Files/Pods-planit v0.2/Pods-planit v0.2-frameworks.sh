...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/HotellookSDK/Library/HotellookSDK.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/LiveGQL/LiveGQL.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Smartling.i18n/Smartling_i18n.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ZKPulseView/ZKPulseView.framework"
