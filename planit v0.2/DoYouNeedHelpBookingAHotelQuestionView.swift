//
//  DoYouNeedHelpBookingAHotelQuestionView.swift
//  planit v0.2
//
...
class DoYouNeedHelpBookingAHotelQuestionView: UIView, UITextViewDelegate {
    ...
    func textView(_ textView: UITextView, shouldChangeTextIn range: NSRange, replacementText text: String) -> Bool {
        if (text == "\n") {
            ...
            NotificationCenter.default.post(name: NSNotification.Name(rawValue: "hotelDontNeedHelpBookingNextPressed"), object: nil)
            return false
        }
        return true
    }
