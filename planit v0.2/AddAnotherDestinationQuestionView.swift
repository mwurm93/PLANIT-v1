//
//  ChooseDestinationTableView.swift
//  planit v0.2
//
//  Created by MICHAEL WURM on 6/20/17.
//  Copyright © 2017 MICHAEL WURM. All rights reserved.
//

import UIKit

class AddAnotherDestinationQuestionView: UIView {
    ...
    func addViews() {
        ...
        button2?.setTitle("Add another", for: .normal)
        button2?.setTitle("Add another", for: .selected)
