...
- (NSString *)tilte {
    return self.isReturn ? NSLS(@"JR_FILTER_RETURN_ARRIVAL_TIME") : NSLS(@"JR_FILTER_ARRIVAL_TIME");
}
...
- (NSString *)tilte {
    return   self.isReturn ? NSLS(@"JR_FILTER_RETURN_DEPARTURE_TIME") : NSLS(@"JR_FILTER_DEPARTURE_TIME");
}
