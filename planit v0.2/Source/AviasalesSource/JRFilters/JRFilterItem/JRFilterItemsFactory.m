...
- (NSArray *)createSectionsForTravelSegment:(JRSDKTravelSegment *)travelSegment {
    ...
    NSArray<id<JRFilterItemProtocol>> *timesItems = [self createDepartureArrivalItemsForTravelSegment:travelSegment forReturn:NO];
...
- (NSArray *)createSectionsForSimpleMode {
    NSMutableArray *sections = [NSMutableArray array];
    JRSDKTravelSegment *firstTravelSegment = self.filter.travelSegmentsBounds.firstObject.travelSegment;
    JRSDKTravelSegment *lastTravelSegment = (self.filter.travelSegmentsBounds.count > 1) ? self.filter.travelSegmentsBounds.lastObject.travelSegment : nil;
    ...
    NSArray<id<JRFilterItemProtocol>> *timesToItems = [self createDepartureArrivalItemsForTravelSegment:firstTravelSegment forReturn:NO];
    if (timesToItems.count > 0) {
        [sections addObject:timesToItems];
    }
    
    if (lastTravelSegment) {
        NSArray<id<JRFilterItemProtocol>> *timesFromItems = [self createDepartureArrivalItemsForTravelSegment:lastTravelSegment forReturn:YES];
...
- (NSArray<id<JRFilterItemProtocol>> *)createGatesItems {
    ...
    if (bounds.gates.count > 1) {
        ...
        for (JRSDKGate *gate in self.filter.ticketBounds.gates) {
            JRFilterGateItem *item = [[JRFilterGateItem alloc] initWithGate:gate];
            item.selected = [bounds.filterGates containsObject:gate];
            
            typeof(item) __weak weakItem = item;
            item.filterAction = ^{
                NSMutableOrderedSet<JRSDKGate *> *gates = [bounds.filterGates mutableCopy];
...
- (NSArray<id<JRFilterItemProtocol>> *)createPaymentMethodsItems {
    ...
    if (bounds.paymentMethods.count > 1) {
        ...
        for (JRSDKPaymentMethod *paymentMethod in self.filter.ticketBounds.paymentMethods) {
            ...
            typeof(item) __weak weakItem = item;
            item.filterAction = ^{
                NSMutableOrderedSet<JRSDKPaymentMethod *> *paymentMethods = [bounds.filterPaymentMethods mutableCopy];
...
- (NSArray<id<JRFilterItemProtocol>> *)createStopoverItemsForFirstTravelSegment:(JRSDKTravelSegment *)firstTravelSegment lastTravelSegment:(JRSDKTravelSegment *)lastTravelSegment {
    NSMutableArray<id<JRFilterItemProtocol>> *items = [NSMutableArray array];
...
- (NSArray<id<JRFilterItemProtocol>> *)createDurationsItemsForFirstTravelSegment:(JRSDKTravelSegment *)firstTravelSegment lastTravelSegment:(JRSDKTravelSegment *)lastTravelSegment {
    NSMutableArray<id<JRFilterItemProtocol>> *items = [NSMutableArray array];
    JRFilterTravelSegmentBounds *firstSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:firstTravelSegment];
    JRFilterTravelSegmentBounds *lastSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:lastTravelSegment];
...
- (NSArray<id<JRFilterItemProtocol>> *)createDepartureArrivalItemsForTravelSegment:(JRSDKTravelSegment *)travelSegment forReturn:(BOOL)isReturn {
    NSMutableArray<id<JRFilterItemProtocol>> *items = [NSMutableArray array];
...
- (NSArray<id<JRFilterItemProtocol>> *)createAirlinesItemsForFirstTravelSegment:(JRSDKTravelSegment *)firstTravelSegment lastTravelSegment:(JRSDKTravelSegment *)lastTravelSegment {
    NSMutableArray<id<JRFilterItemProtocol>> *items = [NSMutableArray array];
    JRFilterTravelSegmentBounds *firstSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:firstTravelSegment];
    JRFilterTravelSegmentBounds *lastSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:lastTravelSegment];
    
    NSMutableOrderedSet<JRSDKAirline *> *airlines = [firstSegmentBounds.airlines mutableCopy];
    NSMutableOrderedSet<JRSDKAirline *> *filterAirlines = [firstSegmentBounds.filterAirlines mutableCopy];
    ...
    if (airlines.count > 1) {
        ...
        for (JRSDKAirline *airline in airlines) {
...
- (NSArray<id<JRFilterItemProtocol>> *)createAlliancesItemsForFirstTravelSegment:(JRSDKTravelSegment *)firstTravelSegment lastTravelSegment:(JRSDKTravelSegment *)lastTravelSegment {
    NSMutableArray<id<JRFilterItemProtocol>> *items = [NSMutableArray array];
    JRFilterTravelSegmentBounds *firstSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:firstTravelSegment];
    JRFilterTravelSegmentBounds *lastSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:lastTravelSegment];
    
    NSMutableOrderedSet<JRSDKAlliance *> *alliances = [firstSegmentBounds.alliances mutableCopy];
    NSMutableOrderedSet<JRSDKAlliance *> *filterAlliances = [firstSegmentBounds.filterAlliances mutableCopy];
    ...
    if (alliances.count > 1) {
        ...
        for (JRSDKAlliance *alliance in alliances) {
...
- (NSArray<id<JRFilterItemProtocol>> *)createAirportsItemsForFirstTravelSegment:(JRSDKTravelSegment *)firstTravelSegment lastTravelSegment:(JRSDKTravelSegment *)lastTravelSegment {
    NSMutableArray<id<JRFilterItemProtocol>> *items = [NSMutableArray array];
...
- (NSArray<id<JRFilterItemProtocol>> *)createOriginAirportsItemsForFirstTravelSegment:(JRSDKTravelSegment *)firstTravelSegment lastTravelSegment:(JRSDKTravelSegment *)lastTravelSegment {
    NSMutableArray<id<JRFilterItemProtocol>> *items = [NSMutableArray array];
    JRFilterTravelSegmentBounds *firstSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:firstTravelSegment];
    JRFilterTravelSegmentBounds *lastSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:lastTravelSegment];
    
    NSMutableOrderedSet<JRSDKAirport *> *originAirports = [firstSegmentBounds.originAirports mutableCopy];
    NSMutableOrderedSet<JRSDKAirport *> *filterOriginAirports = [firstSegmentBounds.filterOriginAirports mutableCopy];
    ...
    for (JRSDKAirport *airport in originAirports) {
...
- (NSArray<id<JRFilterItemProtocol>> *)createStopoverAirportsItemsForFirstTravelSegment:(JRSDKTravelSegment *)firstTravelSegment lastTravelSegment:(JRSDKTravelSegment *)lastTravelSegment {
    NSMutableArray<id<JRFilterItemProtocol>> *items = [NSMutableArray array];
    JRFilterTravelSegmentBounds *firstSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:firstTravelSegment];
    JRFilterTravelSegmentBounds *lastSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:lastTravelSegment];
    
    NSMutableOrderedSet<JRSDKAirport *> *stopoverAirports = [firstSegmentBounds.stopoverAirports mutableCopy];
    NSMutableOrderedSet<JRSDKAirport *> *filterStopoverAirports = [firstSegmentBounds.filterStopoverAirports mutableCopy];
    ...
    for (JRSDKAirport *airport in stopoverAirports) {
        JRFilterAirportItem *item = [[JRFilterAirportItem alloc] initWithAirport:airport];
...
- (NSArray<id<JRFilterItemProtocol>> *)createDestinationAirportsItemsForFirstTravelSegment:(JRSDKTravelSegment *)firstTravelSegment lastTravelSegment:(JRSDKTravelSegment *)lastTravelSegment {
    NSMutableArray<id<JRFilterItemProtocol>> *items = [NSMutableArray array];
    JRFilterTravelSegmentBounds *firstSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:firstTravelSegment];
    JRFilterTravelSegmentBounds *lastSegmentBounds = [self.filter travelSegmentBoundsForTravelSegment:lastTravelSegment];
    
    NSMutableOrderedSet<JRSDKAirport *> *destinationAirports = [firstSegmentBounds.destinationAirports mutableCopy];
    NSMutableOrderedSet<JRSDKAirport *> *filterDestinationAirports = [firstSegmentBounds.filterDestinationAirports mutableCopy];
    ...
    for (JRSDKAirport *airport in destinationAirports) {
        JRFilterAirportItem *item = [[JRFilterAirportItem alloc] initWithAirport:airport];
