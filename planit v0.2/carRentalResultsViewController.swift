//
//  carRentalResultsViewController.swift
//  planit v0.2
//
...
class carRentalResultsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, SMCalloutViewDelegate, UIGestureRecognizerDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if tableView == flightResultsTableView {
            let cell = tableView.dequeueReusableCell(withIdentifier: "carRentalSearchResultTableViewPrototypeCell", for: indexPath) as! carRentalSearchResultTableViewCell
