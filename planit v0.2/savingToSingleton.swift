...
extension UIView {
    ...
    func fetchSavedPreferencesForTrip() -> NSMutableDictionary {
        ...
        let modesOfTransportation = DataContainerSingleton.sharedDataContainer.usertrippreferences?[DataContainerSingleton.sharedDataContainer.currenttrip!].object(forKey: "modesOfTransportation") as? [NSString] ?? [NSString]()
